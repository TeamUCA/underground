...
figlet Underground | lolcat

echo -e  "_____________________________________________________________"
echo -e  "Tools    : Underground Team $white         " |lolcat
echo -e  "Createby  : Cyber_T-rex $white   " |lolcat
echo -e  "Thanks to : all member U.C.A $white " |lolcat
echo -e  "_____________________________________________________________"
...
6) echo "created by : Cyber_T-rex" | lolcat
exit
;;
